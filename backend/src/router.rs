    ...
    Router::new()
        ...
        .merge(
            Router::new()
                ...
                .route(
                    "/absence-categories/all",
                    get(handlers::absence_categories::list_all),
                )
                .route(
                ...
                .route(
                    ...
                    get(handlers::reports::submission_status),
                )
                .route(
                    "/reports/payroll-content",
                    get(handlers::reports::payroll_content),
                )
