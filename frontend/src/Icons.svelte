<script>
  ...
  const icons = {
    ...
    Plane:
      '<path d="M17.8 19.2L16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.4-.1.8.2 1.1L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.6 5.4c.3.3.7.4 1.1.2l.5-.3c.4-.2.5-.7.4-1.1z"/>',
    FileText:
